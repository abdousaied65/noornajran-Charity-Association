...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    deselectAllText: 'عدم تحديد الكل',
    doneButton: false,
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<button type="button" class="actions-btn btn-danger bs-deselect-all btn ' + classNames.BUTTONCLASS + '">' +
      this.options.deselectAllText +
      '</button>' +
      '<button type="button" class="actions-btn btn-success bs-select-all btn ' + classNames.BUTTONCLASS + '">' +
      ...
      '<button type="button" class="btn btn-md ' + classNames.BUTTONCLASS + '">' +
