                ...
                <tr>
                    <td class="content-cell"
                        ...
                        <div style="width: 90%; height: 30px; padding: 10px; background: #0d3349; color:#fff; font-family: 'Cairo';
                            font-size: 16px; margin: 10px auto; border-radius: 5px; text-align: center;"> Message From M7jooz | الادارة </div>
                        <h1 style="box-sizing: border-box; font-family: 'Cairo'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">
                            Hello ! </h1>
                        <p style="box-sizing: border-box; font-family: 'Cairo'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            Please Read The below Message Carefully.</p>
                        <table class="action" align="center" width="100%" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="box-sizing: border-box; font-family: 'Cairo'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; margin: 30px auto; padding: 0; text-align: center; width: 100%;">
                            <tr>
                                <td align="center"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                       ...
                                                       style="box-sizing: border-box; font-family: 'Cairo'; position: relative;">
                                                    <tr>
                                                        <td style="box-sizing: border-box; font-family: 'Cairo'; position: relative;">
                                                            <p>{{$data['message']}}</p>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <p style="box-sizing: border-box; font-family: 'Cairo'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            If you think that it's spam message .. ignore it </p>
                        <p style="box-sizing: border-box; font-family: 'Cairo'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            Regards,<br>
                            M7jooz | الادارة</p>
                    </td>
