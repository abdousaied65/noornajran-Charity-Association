        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="row mt-1 mb-1 text-center justify-content-center align-content-center">
                    <form method="GET" action="{{route('print.selected.specialist_reports')}}">
                        <button type="submit" class="btn btn-md btn-warning m-1 print_selected">
                            <i class="fa fa-print"></i>
                            طباعة
                        </button>
                    </form>
                    <form method="POST" action="{{route('export.specialist_reports.excel')}}">
                        @csrf
                        @method('POST')
                    ...
                    <form method="POST" class="" id="myForm" action="{{route('remove.selected.specialist_reports')}}">
                        @csrf
                        @method('POST')
                    ...
                    <a href="{{route('specialist.specialist_reports.create')}}" role="button"
                ...
                <div class="row p-3">
                    <form method="POST" class="col-lg-6 pull-right d-inline"
                          action="{{route('export.specialist_reports.by.beneficiary.excel')}}">
                        @csrf
                        @method('POST')
                        ...
                        <button style="font-size: 13px!important;" type="submit" class="btn btn-md btn-secondary pull-right d-inline">
                            <i class="fa fa-file-excel-o"></i>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @if($diff < 24)
                                                    ...
                                                    <a href="{{ route('specialist.specialist_reports.edit', $report->id) }}"
                                                       class="dropdown-item">
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('specialist.specialist_reports.destroy', 'test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
...
<script>
    $(document).ready(function () {
        ...
        $('#example-table tfoot tr th:nth-child(3)').html('<input class="form-control" type="text" placeholder="المستفيد" />');
