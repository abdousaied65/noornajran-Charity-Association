            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-12 col-xs-12">
                    <div class="alert alert-danger alert-md text-center mt-4 mb-4">
                        <a class="text-center" href="{{route('volunteer.register')}}">
                    ...
                    <div class="login-form login-area">
                        ...
                        @endif
                        <form id="myForm" class="login-form" method="POST" action="{{route('volunteer.login')}}">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12 pull-left" dir="ltr">
                                        <a href="{{route('volunteer.password.request')}}">هل نسيت كلمة
                                            المرور ؟</a>
                                    </div>
                                </div>
