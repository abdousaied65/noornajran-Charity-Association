                ...
                <div class="col-lg-5 col-md-12 col-xs-12">
                    <div class="login-form login-area">
                        ...
                        <h3 class="text-center mb-4">
                            اعادة تعيين كلمة المرور المتطوعين
                        </h3>
                        @if (session('status'))
                        ...
                        @endif
                        <form id="myForm" action="{{ route('volunteer.password.email') }}" method="post"
                              class="login-form">
                            @csrf
                            ...
                            <div class="form-group mt-4">
                                <ul class="form-links">
                                    <li class="float-left mt-2 mb-4"><a href="{{route('volunteer.register')}}">انشاء
                                            حساب جديد</a></li>
                                    <li class="float-right"><a href="{{route('volunteer.login')}}">العودة الى تسجيل
                                            الدخول </a></li>
                                </ul>
                            </div>
                        </form>
