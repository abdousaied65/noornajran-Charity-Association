        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="row mt-1 mb-1 text-center justify-content-center align-content-center">
                    <form method="GET" action="{{route('print.selected.nationalities')}}">
                        <button type="submit" class="btn btn-md btn-warning m-1 print_selected">
                            <i class="fa fa-print"></i>
                            طباعة
                        </button>
                    </form>
                    <form method="POST" action="{{route('export.nationalities.excel')}}">
                        @csrf
                        @method('POST')
                    ...
                    <form method="POST" class="" id="myForm" action="{{route('remove.selected.nationalities')}}">
                        @csrf
                        @method('POST')
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @endcan
                                                    ...
                                                    @endcan
                                                @can('حذف جنسية')
                                                    <a class="dropdown-item delete_nationality"
                                                       nationality_id="{{ $nationality->id }}"
                                                       nationality="{{ $nationality->nationality }}" data-toggle="modal"
                                                       href="#modaldemo8">
                                                        <i class="fa fa-trash"></i>
                                                        حذف
                                                    </a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100" style="font-family: 'Cairo'; ">حذف جنسية</h6>
...
<script>
    $(document).ready(function () {
        ...
        $('#example-table tfoot tr th:nth-child(3)').html('<input class="form-control" type="text" placeholder="الجنسية" />');
