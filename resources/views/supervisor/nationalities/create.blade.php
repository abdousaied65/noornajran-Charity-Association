        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body p-1 m-1">
                    <form action="{{route('supervisor.nationalities.store','test')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row m-t-3 mb-3">
                            <div class="parsley-input col-md-4" id="fnWrapper">
                                <label> الجنسية <span class="text-danger">*</span></label>
                                <input class="form-control mg-b-20"
                                       data-parsley-class-handler="#lnWrapper" name="nationality" required="" type="text">
                            </div>
                        </div>
