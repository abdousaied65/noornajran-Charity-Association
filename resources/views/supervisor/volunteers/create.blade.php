                    ...
                    <form action="{{route('supervisor.volunteers.store','test')}}" method="post"
                        ...
                        <div class="row m-t-3 mb-3">
                            ...
                            <div class="parsley-input col-md-4 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <input type="date" required class="form-control" value="{{date('Y-m-d')}}" name="start_date"/>
                            </div>
                        </div>
                        <div class="row m-t-3 mb-3">
                            <div class="parsley-input col-md-4 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label class="form-label"> تاريخ انتهاء الاشتراك </label>
                                <input type="date" required class="form-control" value="{{date('Y-m-d')}}" name="end_date"/>
                            </div>
                            ...
                            <div class="col-lg-4 mb-2">
                                ...
                                <input required accept=".pdf" type="file" name="cv" class="form-control">
                            </div>
                        </div>
