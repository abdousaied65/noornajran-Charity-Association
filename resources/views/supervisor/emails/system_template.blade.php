            ...
            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="content-cell"
                        ...
                        <div dir="rtl" style="width: 90%; height: 30px; padding: 10px; background: #0d3349; color:#fff; font-family: 'Cairo';
                            font-size: 16px; margin: 10px auto; border-radius: 5px; text-align: center;line-height: 2;height: 50px;"> رسالة من
                            {{$data['from_email']}}
                        </div>
                        ...
                        font-weight: bold; margin-top: 0; text-align: right;">
                            {{$data['subject']}} </h1>
                            <p>
                                <pre style="font-family: 'Cairo';font-size: 16px!important;; text-align:right;">
                                    {{$data['message']}}
                                </pre>
                            </p>
