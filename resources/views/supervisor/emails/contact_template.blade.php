            ...
            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="content-cell"
                        ...
                        <div style="width: 90%; height: 50px; padding: 10px; background: orangered; color:#fff; font-family: 'Cairo';
                            font-size: 16px; margin: 10px auto; border-radius: 5px; text-align: center;">
                            رسالة من زائر
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="font-family: 'Cairo'!important; position: relative;">
