                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <h5 style="min-width: 300px;" class="pull-right alert alert-md alert-success">
                            تعديل بيانات البريد الالكترونى من القائمة البريدية
                        </h5>
                        <div class="clearfix"></div>
                    </div>
                    <br>
                    {!! Form::model($maillist, ['method' => 'PATCH','enctype' => 'multipart/form-data','route' => ['supervisor.maillists.update', $maillist->id]]) !!}
