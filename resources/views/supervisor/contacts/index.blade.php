                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <ul class="list-group list-group-divider inbox-list">
                            <li class="list-group-item">
                                <a href="{{route('supervisor.contacts.index')}}"><i class="fa fa-inbox"></i> صندوق
                                    الوارد
                                    ({{$data->total()}}) <i
                            ...
                            <li class="list-group-item">
                                <a href="{{route('supervisor.contacts.important')}}"><i class="fa fa-star"></i> الرسائل
                                    المهمة <i
                            ...
                            <div class="mailbox-header">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="mail-search w-50">
                                        <form class="d-inline" action="{{ route('supervisor.contacts.index') }}"
                                              method="get">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    <button type="submit"
                                                            formaction="{{ route('supervisor.contacts.index') }}"
                                                            class="btn btn-info"
                                        ...
                                        <div class="d-flex" style="padding: 10px;">
                                            ...
                                            <div id="inbox-actions" class="m-l-20 m-r-20">
                                                <form class="d-inline" method="post">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button formaction="{{route('supervisor.contacts.make.as.read')}}"
                                                            type="submit"
                                                    ...
                                                    <button
                                                        formaction="{{route('supervisor.contacts.make.as.important')}}"
                                                        type="submit"
                                                        class="btn btn-default btn-md" data-toggle="tooltip"
                                                        data-original-title="تمييزها كمهمة"><i
                                                            class="fa fa-star"></i></button>
                                                    <button
                                                        formaction="{{route('supervisor.contacts.make.as.destroy')}}"
                                                        type="submit"
                                                        class="btn btn-default btn-md" data-toggle="tooltip"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="@if($msg->status == 1) text-muted @elseif($msg->status == 2) text-success  @endif"
                                                   href="{{route('supervisor.contacts.show',$msg->id)}}">{{$msg->name}}
