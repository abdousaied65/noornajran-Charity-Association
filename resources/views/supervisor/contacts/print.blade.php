...
<head>
    ...
    <meta charset="utf-8"/>
    <link rel="icon" href="{{asset($settings->logo)}}" type="image/png">
...
<table class="table table-bordered table-container text-right" @if(App::getLocale()=='ar') dir="rtl" @endif>
    ...
    <tr class="text-center">
        <td><img src="{{asset($settings->logo)}}" class="w-50" alt=""></td>
    </tr>
    </thead>
    <tbody>
    <tr>
    ...
    <tr>
        <td class="thisTD p-3"> البريد الالكترونى :
            {{$message->email
}}</td>
    </tr>
    <tr>
        <td class="thisTD p-3">رقم الجوال :
            {{$message->phone}}</td>
    </tr>
    <tr>
...
<a href="{{route('supervisor.contacts.index')}}" style="margin-right:110px;"
