                ...
                <div class="row mailbox">
                    <div class="col-lg-3 col-md-4">
                        ...
                        <ul class="list-group list-group-divider inbox-list">
                            ...
                            <li class="list-group-item">
                                <a href="{{route('supervisor.contacts.important')}}"><i class="fa fa-star-o"></i> الرسائل
                                    المهمة <i
                            ...
                            <div class="mailbox-header">
                                <div class="d-flex justify-content-between">
                                    <h5 class="d-none d-lg-block inbox-title ml-3"><i
                                            class="fa fa-envelope-o m-r-5"></i> الرسائل المهمة ({{$data->total()}})
                                    </h5>
                                        ...
                                        <div class="d-flex" style="padding: 10px;">
                                            ...
                                            <div id="inbox-actions" class="m-l-20 m-r-20">
                                                <form class="d-inline" method="post">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button formaction="{{route('supervisor.contacts.make.as.destroy')}}"
                                                            type="submit"
                                    ...
                                    @foreach($data as $msg)
                                        <tr>
                                            ...
                                            <td>@if($msg->status == 0) <i
                                                    ...
                                                    class="fa fa-circle text-success"></i> @endif</td>
